...
function initRuntimeSocketService() {
  const hosts = "127.0.0.1,192.168.50.25";
  const port = "8090";
  const id = "mp-weixin_6Ifcv8";
...
const b = true, E = "mp-weixin", P = T(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), C = E, A = T('{"address":["127.0.0.1","192.168.50.25"],"servePort":7001,"debugPort":9000,"initialLaunchType":"local","skipFiles":["<node_internals>/**","/Applications/HBuilderX.app/Contents/HBuilderX/plugins/unicloud/**/*.js"]}'), O = T('[{"provider":"aliyun","spaceName":"uniapp-demo","spaceId":"mp-3d927eed-b92c-498b-904b-7e855f1a1b51","clientSecret":"AtHs1DssqAJtEM3Nh2fCpA==","endpoint":"https://api.next.bspapp.com"}]') || [];
let N = "";
try {
  N = "__UNI__3C8D3B3";
} catch (e2) {
